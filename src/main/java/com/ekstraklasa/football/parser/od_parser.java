...
//https://www.gumtree.pl/s-mieszkania-i-domy-do-wynajecia/page-1/v1c9008p1


    // dom.gratka.pl
    public Flat Parser_gumtree(String url) throws IOException {

        url="https://www.gumtree.pl/a-mieszkania-i-domy-do-wynajecia/krakow/dwupokojowe-ul-szuwarowa/1002109682410910787232609";
        ...
        try{
            ...
            //title;**
            newsHeadlines = doc.select("#div-gpt-oop > div.containment > div > div.content > section > div > div:nth-child(3) > div.vip-header-and-details > div.vip-content-header > div.vip-title.clearfix > h1 > span");
            flat.setTitle(newsHeadlines.text());

            //description;**
            newsHeadlines = doc.select("#div-gpt-oop > div.containment > div > div.content > section > div > div:nth-child(3) > div.vip-header-and-details > div.vip-details > div > span > p");
            flatd.setDescription(newsHeadlines.text());
            ...
            //price;**
            newsHeadlines = doc.select("#div-gpt-oop > div.containment > div > div.content > section > div > div:nth-child(3) > div.vip-header-and-details > div.vip-content-header > div.vip-title.clearfix > div > span > span");
            flat.setPrice(Integer.parseInt(newsHeadlines.text().replaceAll( "[^\\d]", "" )));
    ...
    public ArrayList<String> getUrls_gumtree(Integer pageStart, Integer pageEnd) throws IOException {
        ArrayList<String> allUrls = new ArrayList<String>();
